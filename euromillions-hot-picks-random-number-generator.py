...
drawType = 'Euromillions Hotpicks'
maxMain = 50
ballQty = 0  #  User defined from 1 to 5
mainDrawNumbers = []
lottoNums = 0
valid = True
...
while valid:
  try:
    ballQty = int(input('How many numbers would you like me to generate, 1 to 5:   '))
    if ballQty > 0 and ballQty < 6:
      print('  Cool, I\'m now going to pick you some numbers  ')
      valid = False
    else:
      print('  You didn\'t enter a number between 1 and 5, please try again:  ')
  except:
    print('')
